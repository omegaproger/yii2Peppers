...
<div class="col-sm-3">
    <div class="left-sidebar">
        ...
        <div class="shipping text-center"><!--shipping-->
            <img src="yii2/web/images/home/shipping.jpg" alt="" />
        </div><!--/shipping-->
...
<?php endforeach;?>
    ...
    <div class="col-sm-7">
        <div class="product-information"><!--/product-information-->
            ...
            <h2><?= $product->name?></h2>
            <p>Web ID: 1089772</p>
            <img src="/yii2/web/images/product-details/rating.png" alt="" />
								<span>
            ...
            <a href=""><img src="/yii2/web/images/product-details/share.png" class="share img-responsive"  alt="" /></a>
            <?= $product->content?>
        ...
        <div class="tab-pane fade" id="details" >
                ...
                <div class="product-image-wrapper">
                    <div class="single-products">
                        <div class="productinfo text-center">
                            <img src="/yii2/web/images/home/gallery1.jpg" alt="" />
                            <h2>$56</h2>
            ...
            <div class="col-sm-3">
                <div class="product-image-wrapper">
                    <div class="single-products">
                        <div class="productinfo text-center">
                            <img src="/yii2/web/images/home/gallery2.jpg" alt="" />
                            <h2>$56</h2>
                            <p>Easy Polo Black Edition</p>
                            <button type="button" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</button>
                        </div>
            ...
            <div class="col-sm-3">
                <div class="product-image-wrapper">
                    <div class="single-products">
                        <div class="productinfo text-center">
                            <img src="/yii2/web/images/home/gallery3.jpg" alt="" />
                            <h2>$56</h2>
                            <p>Easy Polo Black Edition</p>
                            <button type="button" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</button>
                        </div>
            ...
            <div class="col-sm-3">
                <div class="product-image-wrapper">
                    <div class="single-products">
                        <div class="productinfo text-center">
                            <img src="/yii2/web/images/home/gallery4.jpg" alt="" />
                            <h2>$56</h2>
                            <p>Easy Polo Black Edition</p>
                            <button type="button" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</button>
                        </div>
        ...
        <div class="tab-pane fade active in" id="reviews" >
            <div class="col-sm-12">
                ...
                <form action="#">
                    ...
                    <b>Rating: </b> <img src="/yii2/web/images/product-details/rating.png" alt="" />
